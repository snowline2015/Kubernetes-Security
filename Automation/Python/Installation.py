...
subprocess.run(
    ...
    'helm install elasticsearch elastic/elasticsearch -f https://raw.githubusercontent.com/snowline2015/' 
        'Kubernetes-Security/main/Doc/Installation/Helm/elasticsearch.yaml', 
    shell=True)



# Kibana
subprocess.run('helm install kibana elastic/kibana -f https://raw.githubusercontent.com/snowline2015/' 
                    'Kubernetes-Security/main/Doc/Installation/Helm/kibana.yaml', 
               shell=True)
...
subprocess.run('kubectl apply -f https://raw.githubusercontent.com/huyvdq2/tetragon_fe/main/k8s.yaml && '
               'kubectl apply -f https://raw.githubusercontent.com/snowline2015/Kubernetes-Security/main/Doc/'
                    'Security/backend.yaml', 
               shell=True)
